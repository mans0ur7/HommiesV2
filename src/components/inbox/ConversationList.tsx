        ...
        {loading ? (
          ...
          <div className="p-8 text-center animate-fade-in">
            ...
            <p className="font-semibold text-foreground text-sm">
              {isGroupTab ? "Ingen gruppesamtaler" : "Ingen samtaler"}
            </p>
            <p className="text-xs text-muted-foreground mt-1 max-w-[180px] mx-auto">
              {isGroupTab 
                ? "Accepter en gruppe-anmodning for at starte"
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      {/* Type badge - show if showTypeBadge is true and not a group conversation */}
                      {showTypeBadge && !conversation.group_id && (
                      ...
                      {/* Group badge - shows on non-group tabs to indicate it's a group conversation */}
                      {conversation.group_id && !isGroupTab && (
                  ...
                  {/* Show property title for all conversations with a property */}
